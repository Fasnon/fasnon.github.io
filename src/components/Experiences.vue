...
<template>
  <div class="h-[calc(100vh-100px)] max-sm:h-[calc(100vh-56px)] flex flex-col pl-40 pt-8 pr-16 bg-muted-green">
    <div class="flex flex-row">
      <div class="basis-3/5 pt-20">

        <div class="font-semibold text-6xl">My Experiences</div>
